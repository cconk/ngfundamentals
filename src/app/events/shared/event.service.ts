...
export class EventService {
    ...
    // not needed because endpoint is smart to recognize if we are sending an event with an id => if yes then update else add so save works for both 
    // use cases
    // updateEvent(event) {
